    ...
    <>
      ...
      <div className={'container mx-auto py-28'}>
        <div className="bo-dashboard">
          <Navbar />
          <div className="bo-dash-content">
            <h1>DASHBOARD</h1>
            <p className="mt-6">
              Bienvenu(e) dans votre DashBoard Reactive Trail.
            </p>
            <div className="flex justify-center items-center mt-6">
              ...
              <a href="/admin/courses/create">
                <button
                  type="button"
                  className="self-end text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none"
            ...
            <div className="flex justify-center items-center mt-6">
              ...
              <a href="/admin/evenements/create">
                <button
                  type="button"
                  className="self-end text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none"
                  href="http://127.0.0.1:5173/createEvenement"
                >
                  Créer un évènement
                </button>
              </a>
