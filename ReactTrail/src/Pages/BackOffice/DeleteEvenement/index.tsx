...
const DeleteEvenement = () => {
    ...
    const handleClick = (eventId) => {
        fetch(API_ROOT_URL+`/api/evenements/${eventId}`, {
            method: "DELETE",
            headers: {
                Accept: "application/json",
            ...
            location.replace("/admin/evenements")
        }).catch((error) => console.log(error));
    }
    ...
    return (
        <div className="relative w-full h-screen bg-white flex items-center shadow dark:bg-gray-700">
            <div className="p-6 text-center grow">
                ...
                <button onClick={e => handleClick(evenement.id)} type="button"
...
export default DeleteEvenement;