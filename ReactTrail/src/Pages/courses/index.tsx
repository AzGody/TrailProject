          ...
          >
            <div className="flex items-center justify-between ">
              <div className="flex flex-col items-start justify-center w-48">
                <label className={'text-white'} htmlFor="course-nom">
                  Nom
                </label>
                <input
                  type="text"
              ...
              <div className="flex flex-col items-start justify-center w-48">
                <label className={'text-white'} htmlFor="course-date">
                  Date
                </label>
                <input
                  type="date"
            ...
            <div className="flex flex-col items-start justify-center w-full mt-4">
              <label className={'text-white'} htmlFor="course-description">
                Description
              </label>
              <textarea
                type="number"
            ...
            <div className="flex flex-col items-start justify-center w-full mt-4 ">
              <label className={'text-white'} htmlFor="course-localisation">
                Événement
              </label>
              <select
                ...
                className="border-black rounded-lg border-solid border p-2 w-full"
              >
                <option value="">ev 1</option>
                <option value="">ev 2</option>
                <option value="">ev 3</option>
              </select>
            </div>
            <div className="flex flex-col items-start justify-center w-full mt-4">
              <label className={'text-white'} htmlFor="course-distance">
                Distance
              </label>
              <input
                type="number"
            ...
            <div className="flex items-center justify-between mt-4">
              <div className="flex flex-col items-start justify-center  w-48">
                <label className={'text-white'} htmlFor="course-denivele-max">
                  Dénivelé positif
                </label>
                <input
                  type="number"
              ...
              <div className="flex flex-col items-start justify-center  w-48">
                <label className={'text-white'} htmlFor="course-denivele-min">
                  Dénivelé négatif
                </label>
                <input
                  type="number"
