      ...
      return <div className="admin-list grow flex items-center justify-center flex-col">
        <div className='flex items-center justify-center w-full text-2xl mb-5'>
            ...
            <a href='/admin/evenements/create'
               className="self-end text-white bg-green-700 hover:bg-green-800 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none"
          ...
          <div className='border-2 p-7 rounded-lg'>
              <form>
                  ...
                  <div className='flex content-between'>
                      <div></div>
                      <button type="submit" value="Envoyer" className="my-1.5 text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none" href="http://127.0.0.1:5173/createCourse">Appliquer</button>
                  </div>
              </form>
          </div>
        </Collapse>
                ...
                (
                  <tr key={evenement.id} className="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                      ...
                      <td className="px-6 py-4 flex">
                          <a href={"/admin/evenements/edit/" + evenement.id}
                                  className="linkToCourse text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                                  <path d="M21.731 2.269a2.625 2.625 0 00-3.712 0l-1.157 1.157 3.712 3.712 1.157-1.157a2.625 2.625 0 000-3.712zM19.513 8.199l-3.712-3.712-12.15 12.15a5.25 5.25 0 00-1.32 2.214l-.8 2.685a.75.75 0 00.933.933l2.685-.8a5.25 5.25 0 002.214-1.32L19.513 8.2z" />
                              </svg>
                          </a>
                          <a href={"/admin/evenements/delete/" + evenement.id}
                                  className="linkToCourse text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
      ...
      return (
        <div className="admin-list">
          ...
          <div className="admin-list-container">
            Aucun événement n'est disponibe pour le moment
          </div>
        </div>
      )
    }
